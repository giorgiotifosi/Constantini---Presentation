...
const SLIDES: SlideData[] = [
  ...
  },
  {
    ...
    imageUrls: [
      getDriveUrl('1gmIn4NUd3kDUERQclfaa4TcyMtlUzOPy'),
      getDriveUrl('1NYd8jT8m4ZeaRT7wBRQFaV1tPEZ4fTEq'),
      getDriveUrl('1ox4d1MPfZgnlRDPU0gzIpAdtEtjp8Qms'),
      getDriveUrl('1SJvI9eUeQoh1ui7PtIEq3_3E_Dm4M9QK'),
      getDriveUrl('1JtiZTPjTseinHVrqr5lu9f34YO5k1ZES'),
      getDriveUrl('19wO6R4wc1DskAaPI1hv1g9AvEew24_H_'),
      getDriveUrl('1_TjCOthAxCH_akOd7DEokUWu870pYmIH'),
      getDriveUrl('100CqE2dKSwEEDCmtrwGNIKXONQi8qlM0'),
      getDriveUrl('1szKrMiv4AlHA7USV8rIlVtScxYWvG0Mh'),
      getDriveUrl('1nPqCgW3tBOPoPR2dhqMfSvijNRxTzVuY'),
      getDriveUrl('1yGAxt3Iktgyo64jrouy_88G-XkJMRd2h'),
      getDriveUrl('17sRO98Lc6MxIQhXUV5rCrmR3CcOBI7ED'),
      getDriveUrl('1Vh9YQQ4m8NlGxgrYQkaZQTK3aldKvxOd'),
      getDriveUrl('1FMJm3gVuToInqvKaEiq0X2diV7XIuuSw'),
      getDriveUrl('10hYhzkWmgya5HmNwKZOptEBrfd93rz1D'),
      getDriveUrl('1grs5A4JliKiCXRQw5MQk7m4-WbR5qhsT'),
      getDriveUrl('102kFcjRTSMXJ9ZPHLB-B7yyZILMtwOMc'),
      getDriveUrl('1SpMrCcp_OmG12kpVohydLsm575HI0DHy'),
      getDriveUrl('1FlyzOMDOoc5Wwi2MJcnigo2eJCOm6mYq'),
      getDriveUrl('1N6Ju66E0QuC6Vz2rbaRvQv3TvbhNTcf_'),
      getDriveUrl('1FPbI26paartXMNwCRu6uDjG9XkaeNycY'),
      getDriveUrl('1g9HxlnJhqU6ex9YsU6LBzzD40UAz96IS'),
      getDriveUrl('1h5ZNuOECkBLlD9uoDmFsQb1WD5J686sw'),
      getDriveUrl('1L_kou2nekkLfd4m_G2nZECjK3KkdjlAR'),
      getDriveUrl('1W5PFcrbg4BlNoXBaxWguGdaHlYjtdndn'),
      getDriveUrl('1q6BA1KCluZIrdwIYTzHMGOdmLVDBhcbw'),
      getDriveUrl('1-nDgXnn4MxWQM3BhqkL_71L8EqHw3Tf0'),
      getDriveUrl('1-Tq2tyl_cbjhUqazUhBeT5Buoqx6OTWf'),
      getDriveUrl('1-_d4OppovfLpkS8Ad5PbMHylN-iYVc1V'),
      getDriveUrl('1qcPjwXtAiqM8m_4xUwZBikGuicpE-IH_'),
      getDriveUrl('1u0O5x_TiCejai98YcEmm1KFpXlT4xePe'),
      getDriveUrl('19KhtaGqYu_MLYvRf2DOHsXO1Coz8kpm8'),
      getDriveUrl('1wnT15MJDSQd5VjTmrLOtzFTs2oMXTD7D'),
      getDriveUrl('1ixpqSCyzU1EZ2_HQRiYfbdxlDgK1pwdM'),
      getDriveUrl('1r2rCKMm6f9lQwuzZpdVW9E27G_3o03j-'),
      getDriveUrl('1DPPprT27OCF_51Vmg_sBH__xjYO0wzu3'),
      getDriveUrl('18taQi0HsbQcYz3blNJTXh4hnc_4qnQjP'),
      getDriveUrl('1pQpoZ39QW4R8E72FXjZtpfPgWObIlceM'),
      getDriveUrl('1URZwf9tlPmXMuAfNs8c5Po4MRZ223eP1'),
      getDriveUrl('1pMDV5ZQkejoVN-HPycpRuitT8qVwxJAX'),
      getDriveUrl('1SVMJJUwe1_kgJhuDkNNza1I_7kYsojwM'),
      getDriveUrl('1HbCEAHjt_poU4bMngp8d_gsnyO08hFj0'),
      getDriveUrl('1vYCuKlbvnFbmtNWOJ9C8TdishtFqgFtF'),
      getDriveUrl('13-x0WWkF-1TJsvNpmwhaus43I_kVGLAL'),
      getDriveUrl('1fwYRJK6S38GhNmCp4Vu3evHT5fdwmC92'),
      getDriveUrl('18fg4f3pLTR6QToC1yGKYByESMI5Kb2uy'),
      getDriveUrl('1R7p8ihkGKtUkAI5ueNRB8HSlH-1LMH1o'),
      getDriveUrl('1_RxQV7PORXoFi9K1H2k_GssmfpYHzW-T'),
      getDriveUrl('1LnCP2fDRbqziDgM0QrUA8sbEWGDu72-8'),
      getDriveUrl('1NVsSSLyMVxEKT1cTEphsUhrRrAib39T_'),
      getDriveUrl('1k-HeP5Id4qbvRdcBZHysuQqBeIqOmV-L'),
      getDriveUrl('1cFs6wRnEKr01mXVoECfCdXpVCro693Ji'),
      getDriveUrl('1nXLKdxVLirDSAKtvcwC_yBlVKwaLGZGQ'),
      getDriveUrl('1Rhv4S67rnoDWfPl-f07LzFI5GWhVlWGQ'),
      getDriveUrl('167i5IrYZ7ob4ZU2ds_ylqhJ-QSTiuVQU'),
      getDriveUrl('1aWXvSuHN3Dcc-d4LAtVl0Y8d-50NL_vk'),
      getDriveUrl('1x0tpHJzcM7olCeNFWZHKVfY6rSfiIBgh'),
      getDriveUrl('1Zl5P6MwRBmBuk92epNKOGYdTiDrYaBtY'),
      getDriveUrl('1ciE5sIXplcS7f9vCe5vlBqNh9GFDX_yS'),
      getDriveUrl('15BR41-CakpON1DdyEydHqQLwPjQKOBgN'),
      getDriveUrl('1BAmNMU_OiKxszeH5wnA5K46xXA0FWM0J'),
      getDriveUrl('1ChxnsMDA5CCzYgtfuDtfZ1L-MfXwxClA'),
      getDriveUrl('1hmOpmDFz9AGZ1NZpdx8qF4h94WkgWOjU'),
      getDriveUrl('18Z56uLo4tcWh46lQmZh2HITZdIk_TfXY'),
      getDriveUrl('18Q6h-59_dAyHDWAaaDPB5eWgFTtdhANY'),
      getDriveUrl('1Scx1ESSgeD2jzWzHqKY44Vfylxo3SCF7'),
